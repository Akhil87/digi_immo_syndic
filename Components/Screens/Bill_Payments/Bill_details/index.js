...
const Bill_Details = ({ navigation, route }) => {
  console.log(route?.params?.billData);
  ...
  useEffect(() => {
    setRecoverData(route?.params?.billData);
    if (Array.isArray(recoverData)) {
      const filteredData = route?.params?.billData?.filter(
                        ...
                        <View style={{ alignItems: "flex-end", gap: 5 }}>
                          ...
                          <Text
                            style={{
                              ...
                              color:
                                item?.status === "PAID" ? "#155724" : "#721c24",
